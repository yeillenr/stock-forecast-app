      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="text-left text-xs text-ink-faint uppercase tracking-wide border-b border-line">
            ...
            <th className="py-2.5 pr-4 font-medium">Consommation moyenne</th>
        ...
        <tbody>
          {rows.map((row) => (
            <tr key={row.warehouse} className="border-b border-line last:border-0">
              ...
              <td className="py-3 pr-4 font-mono">{row.stock}</td>
              <td className="py-3 pr-4 font-mono">{row.average_consumption}</td>
              <td className="py-3 pr-4 font-mono">{row.autonomy} j</td>
              <td className="py-3 pr-4 font-mono">{row.order_in_days} j</td>
